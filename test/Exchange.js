...
describe('Exchange', () => {
    ...
    describe('Making Orders', () => {
        ...
        describe('Success', () => {
            ...
            it('emits an Order event', async () => {
                ...
                expect(args.timestamp).to.exist //timestamp is a dynamic value
            });
        });

        describe('Failure', () => {
            it('fails when no tokens are approved', async () => {
                //reject orders that have no balance
    ...
    describe('Order actions', () => {
        ...
        beforeEach(async () => {
            //user1 deposits tokens before making orders
            transaction = await token1.connect(user1).approve(exchange.address, amount)
            result = await transaction.wait()
            //deposit token
            transaction = await exchange.connect(user1).depositToken(token1.address, amount)
            ...
            //user2 deposits tokens before making orders
        ...
        describe('Cancelling Orders', () => {
            ...
            describe('Failure', () => {
                ...
                it('Rejects orders that are not made by the user', async () => {
        ...
        describe('Filling Orders', () => {
            describe('Success', () => {
                ...
                it('Executes the trade and charges fees', async () => {
                    //check balances after trade to ensure that the trade was executed and fees were charged
